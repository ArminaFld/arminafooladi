...
public class Department{
    ...
    public void addDoctor(Doctor doctor) {
        if (doctor.getSpeciality().equals(this.speciality)) {
            doctors.add(doctor);
            System.out.println("Doctor " + doctor.getName() + " added to the " + name + " department.");
        } else {
            System.out.println("Doctor " + doctor.getName() + " does not match the specialty of " + name + " department.");
        }
    }
